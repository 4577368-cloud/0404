export const TRANSLATIONS = {
    en: {
        ...
        finder: {
            ...
            productPoolSearch: "Tangbuy Product Pool",
        ...
        header: {
            ...
            facebookShareClipboardHint: "Full message (including link) copied. Paste with Ctrl+V / ⌘+V in the Facebook composer if the share window is empty.",
            facebookShareManualPastePrefix: "Facebook: open the post composer and paste with ",
            facebookShareManualPasteShortcut: "Ctrl+V (Windows) or ⌘+V (Mac)",
            facebookShareManualPasteSuffix: " — your copied link and message are ready to paste.",
        },
        auth: {
    ...
    zh: {
        ...
        finder: {
            ...
            productPoolSearch: "Tangbuy 产品池搜索",
        ...
        header: {
            ...
            shareMessageTemplate: "试用了 Tangbuy AI，想看看它到底能做什么。\n\n它基本上是围绕采购打造的 AI——供应商发现、比价与成本分析。\n\n不只是内容生成。\n\n让我印象深刻的是，它帮你重新思考采购决策，而不只是堆数据。\n\n如果你在对接多个供应商或想优化毛利，值得试一试。\n\n{{url}}",
            workflowNoRefreshMarquee: "报告生成中，请勿刷新页面，否则将中断分析。",
            shareLinkLoading: "正在生成专属链接…",
            facebookShareClipboardHint: "完整分享文案（含链接）已复制。若分享窗口没有内容，请在发帖框用 Ctrl+V / ⌘+V 粘贴。",
            facebookShareManualPastePrefix: "Facebook 分享：打开发帖框后，请使用 ",
            facebookShareManualPasteShortcut: "Ctrl+V（Windows）或 ⌘+V（Mac）",
            facebookShareManualPasteSuffix: " 粘贴已复制的链接与文案。",
        },
        auth: {
    ...
    es: {
        ...
        header: {
            ...
            shareMessageTemplate: "Probé Tangbuy AI para ver qué hace en la práctica.\n\nEs básicamente una IA centrada en sourcing: descubrimiento de proveedores, comparación de precios y análisis de costes.\n\nNo solo contenido.\n\nLo que destaca es cómo te ayuda a replantear decisiones de sourcing en lugar de solo mostrar datos.\n\nSi trabajas con varios proveedores o quieres optimizar márgenes, merece la pena probarlo.\n\n{{url}}",
            ...
            facebookShareClipboardHint: "Mensaje completo (con enlace) copiado. Pégalo en el editor de Facebook con Ctrl+V / ⌘+V si la ventana viene vacía.",
            facebookShareManualPastePrefix: "Facebook: abre el editor y pega con ",
            facebookShareManualPasteShortcut: "Ctrl+V (Windows) o ⌘+V (Mac)",
            facebookShareManualPasteSuffix: " — el enlace y el texto ya están copiados.",
        },
        auth: {
    ...
    fr: {
        ...
        header: {
            ...
            shareMessageTemplate: "J’ai testé Tangbuy AI pour voir ce qu’il fait vraiment.\n\nC’est une IA centrée sur le sourcing : découverte fournisseurs, comparaison de prix et analyse des coûts.\n\nPas seulement du contenu.\n\nCe qui marque, c’est qu’elle aide à repenser les décisions d’approvisionnement plutôt qu’à empiler des données.\n\nSi vous avez plusieurs fournisseurs ou voulez optimiser vos marges, ça vaut le coup d’essayer.\n\n{{url}}",
            ...
            facebookShareClipboardHint: "Message complet (lien inclus) copié. Collez-le dans Facebook avec Ctrl+V / ⌘V si la fenêtre est vide.",
            facebookShareManualPastePrefix: "Facebook : ouvrez la zone de publication et collez avec ",
            facebookShareManualPasteShortcut: "Ctrl+V (Windows) ou ⌘+V (Mac)",
            facebookShareManualPasteSuffix: " — le lien et le texte sont déjà copiés.",
        },
        auth: {
