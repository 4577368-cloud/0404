export const TRANSLATIONS = {
    en: {
        ...
        header: {
            ...
            facebookShareClipboardHint: "Full message copied. Paste (Ctrl+V / ⌘V) into the Facebook box.",
            facebookShareConfigureHint: "Auto-fill in Facebook: set VITE_FACEBOOK_APP_ID to your Meta app ID in env (see .env.example). Without it, we copy the text and open the classic share window.",
        },
        auth: {
    ...
    zh: {
        ...
        header: {
            ...
            shareMessageTemplate: "⚡ 店铺隐患在哪？Tangbuy AI 帮你找。\n✅ 产品诊断\n✅ 市场缺口分析\n✅ 跨境优化建议\n完全免费，30 秒见洞察。\n👉 {{url}}\n#TangbuyDropshipping #EcommerceAI #SmartSelling",
            workflowNoRefreshMarquee: "报告生成中，请勿刷新页面，否则将中断分析。",
            shareLinkLoading: "正在生成专属链接…",
            facebookShareClipboardHint: "完整文案已复制，请在 Facebook 发帖框中粘贴（Ctrl+V 或 ⌘+V）。",
            facebookShareConfigureHint: "在 Facebook 内自动填入文案：请在环境变量中配置 VITE_FACEBOOK_APP_ID（Meta 应用编号，见 .env.example）。未配置时将复制全文并打开传统分享页。",
        },
        auth: {
    ...
    es: {
        ...
        header: {
            ...
            shareMessageTemplate: "⚡ ¿Fugas ocultas en tu tienda? Tangbuy AI las encuentra.\n✅ Diagnóstico de producto\n✅ Análisis de brechas de mercado\n✅ Tips de optimización cross-border\n100% gratis. Insights en 30 segundos.\n👉 {{url}}\n#TangbuyDropshipping #EcommerceAI #SmartSelling",
            ...
            facebookShareClipboardHint: "Mensaje copiado. Pégalo en Facebook (Ctrl+V / ⌘V).",
            facebookShareConfigureHint: "Autocompletar en Facebook: configura VITE_FACEBOOK_APP_ID (ID de app Meta) en el entorno. Si no, copiamos el texto y abrimos la ventana clásica.",
        },
        auth: {
    ...
    fr: {
        ...
        header: {
            ...
            shareMessageTemplate: "⚡ Fuites cachées dans votre boutique ? Tangbuy AI les détecte.\n✅ Diagnostic produit\n✅ Analyse des gaps marché\n✅ Conseils d'optimisation cross-border\n100% gratuit. Insights en 30 secondes.\n👉 {{url}}\n#TangbuyDropshipping #EcommerceAI #SmartSelling",
            ...
            facebookShareClipboardHint: "Texte copié. Collez-le dans Facebook (Ctrl+V / ⌘V).",
            facebookShareConfigureHint: "Remplissage auto sur Facebook : définissez VITE_FACEBOOK_APP_ID (ID d’app Meta) dans l’environnement. Sinon, copie + fenêtre de partage classique.",
        },
        auth: {
