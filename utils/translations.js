export const TRANSLATIONS = {
    en: {
        ...
        header: {
            ...
            facebookShareClipboardHint: "Link copied. Paste (Ctrl+V / ⌘V) into Facebook if needed.",
            facebookShareConfigureHint: "Auto-fill in Facebook: set VITE_FACEBOOK_APP_ID to your Meta app ID in env (see .env.example). Without it, we copy the link and open the classic share window.",
        },
        auth: {
    ...
    zh: {
        ...
        header: {
            ...
            facebookShareClipboardHint: "专属链接已复制，可在 Facebook 发帖框粘贴（Ctrl+V 或 ⌘+V）。",
            facebookShareConfigureHint: "在 Facebook 内自动填入引用：请在环境变量中配置 VITE_FACEBOOK_APP_ID（Meta 应用编号，见 .env.example）。未配置时将复制专属链接并打开传统分享页。",
        },
        auth: {
    ...
    es: {
        ...
        header: {
            ...
            facebookShareClipboardHint: "Enlace copiado. Pégalo en Facebook si lo necesitas (Ctrl+V / ⌘V).",
            facebookShareConfigureHint: "Autocompletar en Facebook: configura VITE_FACEBOOK_APP_ID (ID de app Meta) en el entorno. Si no, copiamos el enlace y abrimos la ventana clásica.",
        },
        auth: {
    ...
    fr: {
        ...
        header: {
            ...
            facebookShareClipboardHint: "Lien copié. Collez-le dans Facebook si besoin (Ctrl+V / ⌘V).",
            facebookShareConfigureHint: "Remplissage auto sur Facebook : définissez VITE_FACEBOOK_APP_ID (ID d’app Meta) dans l’environnement. Sinon, copie du lien + fenêtre de partage classique.",
        },
        auth: {
